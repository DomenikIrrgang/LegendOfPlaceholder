...
func _ready() -> void:
	...
	SaveFileManager.game_state_saving.connect(on_saving)
...
func on_saving(game_state: Dictionary) -> void:
	...
	game_state.current_quests = current_quest_data
	game_state.completed_quests = completed_quests.map(SaveFileManager.get_resource_uid)

func on_load(game_state: Dictionary) -> void:
	for quest_data in game_state.current_quests:
	...
	completed_quests.assign(game_state.completed_quests.map(SaveFileManager.get_resource_from_uid))
